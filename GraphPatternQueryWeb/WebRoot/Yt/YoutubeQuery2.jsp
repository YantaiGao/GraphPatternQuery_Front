...
<html lang="zh-CN">
  ...
  <div class="container">
  	  <div class="col-xs-12">
  	   <div class="col-md-7">
  	    <h2>Youtube Query 2 Pattern图</h2>
	    <!--
	    ../不对，直接images才对，为什么呢 
	    <img src="../images/YtQ1.jpg" class="img-responsive" alt="Pattern Graph" width="304" height="236">
	    -->
	    <img src="images/YtQ2.jpg" class="img-responsive" alt="Pattern Graph" width="304" height="236">
	  </div>
	  <div class="col-md-5">
	    <h2>Youtube数据集属性说明：</h2>
	    <br/>
	    <ul>
  		  <li style="font-size: 21px;">1-uploader:上传者</li>
  	   	  <li style="font-size: 21px;">2-age:上传时间</li>
  		  <li style="font-size: 21px;">3-category:视频分类</li>
   		  <li style="font-size: 21px;">4-length:视频时长</li>
   		  <li style="font-size: 21px;">5-views:观看次数</li>
  		  <li style="font-size: 21px;">6-rate:平均评分</li>
   		  <li style="font-size: 21px;">7-ratings:评分人数</li>
   		  <li style="font-size: 21px;">8-comments:评论数</li>
		</ul>
	  </div>
	  </div>
  </div>
